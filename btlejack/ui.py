...
class CLISendTestPacket(SendTestPacket):
    ...
    def send_test_packet(self):
       ...
       # payload = bytes([0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
        ...
        payload = bytes([0x55, 0xb0, 0xfd, 0xfc, 0x46, 0xd4, 0xc5, 0xe7, 0x2a, 0x40, 0x25, 0x40,
                         0xC9, 0x24, 0xFB, 0xB4, 0x83, 0xA7, 0x8C, 0x8E, 0x12, 0x26, 0x14, 0xEB,
                         0x5E, 0x6E, 0x2D, 0x44, 0xD5, 0x77, 0xF5, 0x8D, 0x53, 0x6D, 0xC6, 0x63,
                         0x0B, 0x5D, 0xCC, 0x88, 0x50, 0x9E, 0xE4, 0x09, 0x02])
